...
# Verbinding voor de grafiek (Maandoverzicht)
...
# --- DATA OPHALEN ---
val_s, status_s = fetch_data_with_status(URL_1)
val_g, status_g = fetch_data_with_status(URL_2)
val_t = val_s + val_g
