...
# ==========================================
# SOLAR PIEK PRO v14.9 - MPPT INTEGRATED
# ==========================================
...
# URL voor MPPT data van de Symo (DeviceId 2 volgens systeeminfo)
...
def fetch_mppt_live(url):
    try:
        r = requests.get(url, timeout=1.5).json()
        d = r['Body']['Data']
        # Fallback voor verschillende veldnamen (UDC vs UDC_1)
