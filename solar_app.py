...
# ==========================================
# SOLAR PIEK PRO - VOLLEDIG HERSTEL + WEER ☀️
# ==========================================
...
# --- WEER FUNCTIE (SIMPEL & STABIEL) ---
def get_weather():
    try:
        url = "https://open-meteo.com"
        res = requests.get(url, timeout=3).json()
        
        # Bepaal icoon op basis van weercode
...
if current_w:
    ...
    w2.metric("🌤️ Max Today", f"{daily_w['temperature_2m_max']}°C")
