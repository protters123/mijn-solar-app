...
# 1. Google Sheet Configuratie
SHEET_ID = "19wEhTv_-3PkwWl3dnp8xn_e5SKtwBmuJO4yS8W-uEmo"
SHEET_NAME = "Historiek"

# URL handmatig samenstellen om f-string fouten te voorkomen
...
st.caption(f"Laatste check: {datetime.now().strftime('%H:%M:%S')} | 2 sec interval")
